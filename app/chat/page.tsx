...
export default function ChatPage() {
  ...
  return (
    <div className="relative h-full flex items-center justify-center overflow-hidden bg-[#F8F4E1]">
      ...
      <div className="relative z-10 text-center max-w-sm px-4">
        ...
        {/* ===== Security hint ===== */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/70 border border-[#74512D]/10 shadow-sm text-xs text-[#74512D]">
